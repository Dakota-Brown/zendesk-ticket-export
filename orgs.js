...
var options = {
    url: 'https://southbayautomation.zendesk.com/api/v2/incremental/organizations.json?start_time=1262304000',
    auth: {
...
function callback(error, response, body) {
    ...
    if (!error && response.statusCode == 200) {
        ...
        console.log(org_data.organizations[0].organization_fields)
        const final = [];
